...
values ('Первая','Доктор Борменталь','Создание собак из человечков');
insert into groups(groupName, curator, speciality)
values ('Вторая','Профессор Преображенский','Создание собак из человечков');

insert into students (firstName,surName,patronymic,sex, dateOfBirth,group_id, educationYear)
